...
class NcryptThemes {
  final ThemeData ncryptThemeData = new ThemeData(
      ...
      floatingActionButtonTheme: FloatingActionButtonThemeData(
          backgroundColor: Color(0xFF061E22), foregroundColor: Colors.white),
  ...
  final ThemeData lightThemeData = new ThemeData(
      ...
      colorScheme: ColorScheme.fromSwatch()
          .copyWith(primary: Colors.cyan[150], secondary: Colors.grey[800]));
  ...
  ThemeData getTheme(String themeString) {
    ...
    switch (theme) {
      case Themes.DARK_THEME:
        return ncryptThemeData;
      case Themes.LIGHT_THEME:
        return lightThemeData;
      case Themes.NEO_THEME:
        return neoThemeData;
      default:
        return ncryptThemeData;
    }
